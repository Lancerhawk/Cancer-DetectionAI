  ...
  return (
    <div className="cancer-detail">
      ...
      <div className="scan-images">
        <h3>Endoscopy:</h3>
        {endoscopy && <img src={URL.createObjectURL(endoscopy)} alt="Endoscopy for Esophageal Cancer" />}
        <h3>Biopsy:</h3>
        {biopsy && <img src={URL.createObjectURL(biopsy)} alt="Biopsy for Esophageal Cancer" />}
      </div>
    </div>
  );
};

export default EsophagealCancer;

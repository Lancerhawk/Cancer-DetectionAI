  ...
  return (
    <div className="cancer-detail">
      ...
      <div className="scan-images">
        <h3>CT Scan:</h3>
        {ctScan && <img src={URL.createObjectURL(ctScan)} alt="CT Scan for Mouth and Throat Cancer" />}
        <h3>Biopsy:</h3>
        {biopsy && <img src={URL.createObjectURL(biopsy)} alt="Biopsy for Mouth and Throat Cancer" />}
      </div>
    </div>
  );
};

export default MouthAndThroatCancer;

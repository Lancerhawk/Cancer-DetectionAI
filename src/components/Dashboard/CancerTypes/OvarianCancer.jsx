  ...
  return (
    <div className="cancer-detail">
      ...
      <div className="scan-images">
        <h3>Ultrasound:</h3>
        {ultrasound && <img src={URL.createObjectURL(ultrasound)} alt="Ultrasound for Ovarian Cancer" />}
        <h3>Biopsy:</h3>
        {biopsy && <img src={URL.createObjectURL(biopsy)} alt="Biopsy for Ovarian Cancer" />}
      </div>
    </div>
  );
};
